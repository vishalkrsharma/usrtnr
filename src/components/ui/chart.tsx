...
type ChartTooltipContentProps = {
  ...
  formatter?: (value: string | number, name: string | number, item: TooltipPayload, index: number, payload: Record<string, any>) => React.ReactNode;
  color?: string;
  nameKey?: string;
  labelKey?: string;
};
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: TooltipPayload | LegendPayload, key: string) {
